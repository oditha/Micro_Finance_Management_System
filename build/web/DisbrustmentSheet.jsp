...
<%@page import="Servlets.MicroFinance.ViewDisbursmentJasper"%>
<%@page import="Holders.DisbrustmentHolder"%>
    ...
    <body>
        <%
            ...
            try {
                ...
                JRBeanCollectionDataSource bcd = new JRBeanCollectionDataSource(ViewDisbursmentJasper.holder);
                mp.put("Bean", bcd);

                System.err.println(mp);
                InputStream input = getClass().getResourceAsStream("/JReports/MCDisbrustSheet.jrxml");
