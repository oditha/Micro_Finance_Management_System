                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="center" name="center">
                            ...
                            <%                                Session se = PoolManager.getSessionFactory().openSession();
                                Criteria c = se.createCriteria(CenterHasStaff.class);

                                c.createAlias("staff", "s");

                                c.add(Restrictions.eq("s.idStaff", session.getAttribute("id")));

                                List<CenterHasStaff> l = c.list();

                                for (CenterHasStaff elem : l) {

                                    if (elem.getCenter().getIsActive().equals("Active") && elem.getCenter().getIsApprove().equals("Approve")) {
