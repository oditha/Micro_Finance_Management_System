...
<div class="alert alert-success" role="alert">
  <strong>Well done!</strong> You successfully Added a Leave request
</div>
...
<div class="card">
    ...
    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
        <div class="card-block">
            ...
            <div class="container">
                <form action="../AddLeaveServletExecutive?id=<%=session.getAttribute("id").toString() %>" method="POST">
                    <div class="row">
            ...
            //  cr.add(Restrictions.eq("requestedDate", dateFormat.MonthOnly()));
              ...
              for (Staffleave sl : l) {%>
                  ...
                  <tr>
                    ...
                    <td><a href="../RemoveLeaveServlet?id=<% out.print(sl.getIdstaffLeave());   %>" class="btn btn-primary btn-sm">Remove</a></td>
