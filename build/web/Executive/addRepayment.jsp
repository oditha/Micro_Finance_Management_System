...
<%
    ...
    PageTitleSet.getTitle().setPAGE_TITLE("Add Payment");
                        ...
                        <form action="addRepaymentBulk.jsp" method="POST">
                            ...
                            <select class="form-control" id="selectCenter" name="selectCenter">
                                ...
                                //    cr.add(Restrictions.eq("isApprove", "Approve"));
                                    ...
                                    Staff sss = (Staff) cr.uniqueResult();

                                    Iterator it = sss.getCenterHasStaffs().iterator();

                                    while (it.hasNext()) {
                                        
                                       CenterHasStaff c= (CenterHasStaff)it.next();

                                %>

                                <option value="<%= c.getCenter().getIdCenter()%>"><%= c.getCenter().getCenterNo() + " - " + c.getCenter().getCenterName()%></option>
...
<!--Table Section-->
        ...
        <div class="container">
            <form action="../AddRepaymentServletEXE" id="myForm0">
                <div class="container">
                    <div class="row">
