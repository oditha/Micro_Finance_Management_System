            ...
            <div class="row">	
                ...
                <div class="col-md-3">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="search" placeholder="Enter Member ID or NIC" name="memberid">
                        <div class="containerfluid text-right" style="padding-top: 10px;"><input type="submit" id="Filter" value="Filter" name="Search" class="btn btn-primary text-right btn-sm "></div>
...
//-----------LoadBasic Data-----------------------------------------------------
    ...
    $("#Filter").click(function () {
        ...
        $("input[type=tel]").val("");
        $("#loanIndex").empty();
        $("#loanIndex").append('<option>Select</option>');
//        $('#loanIndex').val(null)
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res !== "error") {
                    ...
                    var sum2 = table.column(3).data().sum();
                    $('#loanamount').val(sum2);
                } else {
