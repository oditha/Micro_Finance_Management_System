    ...
    <div class="card">
        ...
        <div id="collapseOne" class="collapse " role="tabpanel" aria-labelledby="headingOne">
            <div class="card-block">
                ...
                <form action="../AddRenewLoanServlet" id="myForm" method="POST">
...
<!--<div class="card">
    ...
    <div class="card-block">-->
        <div class="container">
            <form action="../AddLoanServlet" id="myForm" method="POST">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-right"><button class="btn btn-primary text-right" id="g1"> Change Guarantor </button></div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="text-right"><button class="btn btn-primary text-right" id="g2"> Change Guarantor </button></div>
...
<div class="modal fade Guaranter1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Change Guaranter 1</h5>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="exampleSelect1">Select Guarantee1</label>
                    <select class="form-control" id="g1combo" style="color: black; width: 300px;" >
                ...
                <button type="button" class="btn btn-primary saveg1">Save changes</button>
...
<div class="modal fade Guaranter2">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Change Guaranter 2</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="form-group">
                    <label for="exampleSelect1">Select Guarantee2</label>
                    <select class="form-control" id="g2combo" style="color: black; width: 300px;" >
                        <option value="">Select</option>
                    </select>

                    <button type="button" class="btn btn-primary saveg2" id="save">Save changes</button>
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                </div>
            </div>
...
//------------------Load All Loan Records---------------
    ...
    $(document).ready(function () {
        ...
        $('.saveg1').click(function () {


            $('#Guarantor10').val("");
            $('#Guarantor10').val($('#g1combo :selected').text());
            $('.Guaranter1').modal('hide');
        });
        $('.saveg2').click(function () {


            $('#Guarantor20').val("");
            $('#Guarantor20').val($('#g2combo :selected').text());
            $('.Guaranter2').modal('hide');
        });
        $("#g1").click(function () {
            $('#g1combo').find('option').remove();
            $('#g1combo').append('<option>' + 'Select' + '</option>');
            //
            $.ajax({
                method: 'post',
                url: '../LoadGuaranteer',
                data: {memberID: $('#memberNo0').val()},
                success: function (responseText) {
                    ...
                    for (var i = 0; i < j.length; i++) {
                        ...
                        $('#g1combo').append('<option>' + j[i].no + '</option>');
                    }
        ...
        $("#g2").click(function () {
            ...
            $('#g2combo').find('option').remove();
            $('#g2combo').append('<option>' + 'Select' + '</option>');
            //
            $.ajax({
                method: 'post',
                url: '../LoadGuaranteer',
                ...
                success: function (responseText) {
                    ...
                    for (var i = 0; i < j.length; i++) {
                        ...
                        $('#g2combo').append('<option>' + j[i].no + '</option>');
                    }
