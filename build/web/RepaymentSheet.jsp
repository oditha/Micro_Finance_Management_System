    ...
    <body>
        <%
            ...
            try {
                ...
                JRBeanCollectionDataSource bcd = new JRBeanCollectionDataSource(RepaymentSheetJasper.holder);
                mp.put("Bean", bcd);

                System.err.println(mp);
                InputStream input = getClass().getResourceAsStream("/JReports/MCRepaymentSheet.jrxml");
