...
<div class="card">
    ...
    <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo">
        <div class="card-block">
            <form action="../AddResignation" method="Post">
                <div class="container">
                    <div class="row">
            ...
            <table class="table table-stripped" id="restable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="../DeleteResignationServlet?hid=<%=res.getIdResignation()%> " class="btn btn-primary cls">Delete</a> </td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <form action="../DeleteResignationServlet" style="padding: 0px; padding-top: 16px;">  
