                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="example-5000" id="example-5000" required="">

                            </div>
                            <div class="form-group">
                                <label for="example-search-input">2000.00</label>

                                <input class="form-control" type="text" name="example-2000" id="example-2000" required="">

                            </div>
                            <div class="form-group">
                                <label for="example-email-input">1000.00</label>

                                <input class="form-control" type="text" name="example-1000"  id="example-1000" required="">

                            </div>
                            <div class="form-group">
                                <label for="example-url-input">500.00</label>

                                <input class="form-control" type="text" name="example-500" id="example-500" required="">

                            </div>
                            <div class="form-group">
                                <label for="example-url-input">100.00</label>

                                <input class="form-control" type="text" name="example-100" id="example-100" required="">
