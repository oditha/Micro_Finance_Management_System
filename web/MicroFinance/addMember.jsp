    ...
    <div class="card">
        ...
        <div id="collapseOne" class="collapse " role="tabpanel" aria-labelledby="headingOne">
            <div class="card-block">
                ...
                <form action="../AddMemberServlet" id="myForm">
                    <div class="container">
                        <div class="row">
    ...
    $('.bt-mod').click(function () {
        ...
        $.ajax({
            ...
            success: function (responseText) {
                ...
                $("#memdob").datepicker("setDate", memdob);
                ...
                <form action="../UpdateMemberServlet" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="form-group">
                                <label for="formGroupExampleInput">Select Center</label>
                                <select class="form-control yourExcludeClass" id="centerID" name="center" onchange="select()">
                                    <option>Select</option>
