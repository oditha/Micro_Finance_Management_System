...
@WebServlet(name="LoadMemberDataRenewLoanAJAX", urlPatterns={"/LoadMemberDataRenewLoanAJAX"})
public class LoadMemberDataRenewLoanAJAX extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                createCriteria.add(Restrictions.eq("idMembers", Integer.parseInt(parameter)));
