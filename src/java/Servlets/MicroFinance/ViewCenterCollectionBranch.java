...
@WebServlet(name = "ViewCenterCollectionBranch", urlPatterns = {"/ViewCenterCollectionBranch"})
public class ViewCenterCollectionBranch extends HttpServlet {
            ...
            try {
                ...
                if (true) {
                    ...
                    for (Center chs : list) {
                        ...
                        Iterator it = chs.getMemberses().iterator();
                            ...
                            if (mem.getIsActive().equals("Active")) {
                                ...
                                while (it2.hasNext()) {
                                    ...
                                    if (loan.getIsActive().equals("Active") && loan.getIsAprove().equals("Approve")) {
                                        ...
                                        if (issueDate.equals(setDateFull) && loan.getIsActive().equals("Active")
