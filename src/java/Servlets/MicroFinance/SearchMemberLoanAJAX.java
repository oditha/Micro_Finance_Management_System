...
@WebServlet(name = "SearchMemberLoanAJAX", urlPatterns = {"/SearchMemberLoanAJAX"})
public class SearchMemberLoanAJAX extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                if (radio.equals("nic")) {
                    ...
                    createCriteria.add(Restrictions.eq("nic", parameter));
                    ...
                    Criteria createCriteria = openSession.createCriteria(Members.class);
                    createCriteria.add(Restrictions.eq("memberNo", parameter));
                    createCriteria.add(Restrictions.eq("isActive", "Active"));
                    Members ur = (Members) createCriteria.uniqueResult();
