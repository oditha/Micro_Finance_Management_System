            ...
            try {
                ...
                switch (request.getSession().getAttribute("UserType").toString()) {
                    ...
                    case "Executive":
                        ...
                        break;
                    default:
                        response.sendRedirect("Cashier/addMember.jsp?save=done");
                        break;
                }
//                session.close();
            } catch (Exception e) {
                ...
                switch (request.getSession().getAttribute("UserType").toString()) {
                    case "Manager":
                        response.sendRedirect("MicroFinance/addMember.jsp?save=error");
                        break;
                    case "Executive":
                        response.sendRedirect("Executive/addMember.jsp?save=error");
                        break;
                    default:
                        response.sendRedirect("Cashier/addMember.jsp?save=error");
                        break;
                }
