...
import static Singleton.dateFormat.DateFullCurrent;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                la.setDescription("New loan for Loan #" + loan.getContractNo());
                ...
                cash.setDescription("New loan for Loan #" + loan.getContractNo());
