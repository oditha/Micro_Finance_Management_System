...
@WebServlet(name = "ViewDisbursmentExecutiveFilter", urlPatterns = {"/ViewDisbursmentExecutiveFilter"})
public class ViewDisbursmentExecutiveFilter extends HttpServlet {
