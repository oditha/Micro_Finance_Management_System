...
@WebServlet(name = "AddRepaymentCashierServlet", urlPatterns = {"/AddRepaymentCashierServlet"})
public class AddRepaymentCashierServlet extends HttpServlet {
...
//                Session sess = PoolManager.getSessionFactory().openSession();
                ...
                repayment.setArreas("CashierPayment");
                ...
                response.sendRedirect("Cashier/addRepayment.jsp?save=done");

            } catch (Exception e) {

                response.sendRedirect("Cashier/addRepayment.jsp?save=error");
