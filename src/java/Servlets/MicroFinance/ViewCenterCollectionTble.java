...
@WebServlet(name = "ViewCenterCollectionTble", urlPatterns = {"/ViewCenterCollectionTble"})
public class ViewCenterCollectionTble extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            double NPcollection = 0.0;
            double memberfee = 0.0;
            double totalLoan = 0.0;

            double excepted = 0.00;

            JSONArray jsonArray = new JSONArray();
            Session openSession = PoolManager.getSessionFactory().openSession();

            Criteria createCriteria = openSession.createCriteria(Center.class);
            System.out.println("Date "+setDateFull);
            System.out.println("Day "+dateFormat.parseDate(setDateFull));
            ...
            String centerno1 = null;
            String centerno2 = null;
            String centerno3 = null;
            ...
            for (Center center : list) {
                ...
                while (it.hasNext()) {
                    ...
                    if (centerhasstaff.getStaff().getIdStaff() == Integer.parseInt(idStaff)) {
