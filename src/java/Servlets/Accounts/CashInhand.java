 ...
 * @author arshak
 */
@WebServlet(name = "CashInhand", urlPatterns = {"/CashInhand"})
public class CashInhand extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Criteria cr = sess.createCriteria(CashInHandAcc.class);
            ...
            List<CashInHandAcc> list = cr.list();

            JSONArray arr = new JSONArray();

            for (CashInHandAcc loanAccount : list) {
