 ...
 * @author arshak
 */
@WebServlet(name = "ViewIntrestAccounts", urlPatterns = {"/ViewIntrestAccounts"})
public class ViewIntrestAccounts extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Criteria cr = sess.createCriteria(InterestAccount.class);
            ...
            List<InterestAccount> list = cr.list();
            
            
            JSONArray arr = new JSONArray();
            
            for (InterestAccount loanAccount : list) {
