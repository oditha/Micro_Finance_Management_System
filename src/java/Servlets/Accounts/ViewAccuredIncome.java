 ...
 * @author arshak
 */
@WebServlet(name = "ViewAccuredIncome", urlPatterns = {"/ViewAccuredIncome"})
public class ViewAccuredIncome extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Criteria cr = sess.createCriteria(AccruedIncomeAccount.class);
            ...
            List<AccruedIncomeAccount> list = cr.list();

            JSONArray arr = new JSONArray();

            for (AccruedIncomeAccount loanAccount : list) {
