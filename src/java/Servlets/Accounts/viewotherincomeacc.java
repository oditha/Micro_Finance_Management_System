 ...
 * @author arshak
 */
@WebServlet(name = "viewotherincomeacc", urlPatterns = {"/viewotherincomeacc"})
public class viewotherincomeacc extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
           ...
           try {
            ...
            Criteria cr = sess.createCriteria(OtherIncomeAcc.class);
            ...
            List<OtherIncomeAcc> list = cr.list();
            
            
            JSONArray arr = new JSONArray();
            
            for (OtherIncomeAcc loanAccount : list) {
