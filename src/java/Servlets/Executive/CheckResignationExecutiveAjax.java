 ...
 * @author iamarshrx
 */
@WebServlet(name = "CheckResignationExecutiveAjax", urlPatterns = {"/CheckResignationExecutiveAjax"})
public class CheckResignationExecutiveAjax extends HttpServlet {
...
//            Resignation rs=(Resignation) cr.uniqueResult();
//            
