 ...
 * @author iamarshrx
 */
@WebServlet(name = "AddResignationExecutive", urlPatterns = {"/AddResignationExecutive"})
public class AddResignationExecutive extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            try {
                ...
                tr.commit();
                sess.close();
                response.sendRedirect("Executive/AddResignationExecutive.jsp?save=success");
