...
import static Servlets.MicroFinance.AddRepaymentServlet.holder;
...
@WebServlet(name = "AddRepaymentServletEXE", urlPatterns = {"/AddRepaymentServletEXE"})
public class AddRepaymentServletEXE extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                System.out.println("Start Search Payment");
                ...
                double totalPaid = Double.parseDouble(list.get(0).toString());
                double loanAmo = Double.parseDouble(loanAmount);
                System.out.println("Payment Search Done");
                if (totalPaid == loanAmo) {
                    System.out.println("Loan Can Settle");
...
//                    session1.close();
                ...
                response.sendRedirect("Executive/addRepayment.jsp?save=done");

            } catch (Exception e) {

                response.sendRedirect("Executive/addRepayment.jsp?save=error");
