...
@WebServlet(name = "AddMemberServletts", urlPatterns = {"/AddMemberServletts"})
public class AddMemberServletts extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                last++;
                get.add(last);
                response.sendRedirect("/CMC/Executive/addMember.jsp?save=done");
//                session.close();
            } catch (Exception e) {

                response.sendRedirect("/CMC/Executive/addMember.jsp?save=error");
