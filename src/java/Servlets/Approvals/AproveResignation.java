 ...
 * @author iamarshrx
 */
@WebServlet(name = "AproveResignation", urlPatterns = {"/AproveResignation"})
public class AproveResignation extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Resignation resignation = (Resignation) cr.uniqueResult();
            
            
            List<Resignation> l = cr.list();
            JSONArray arr = new JSONArray();
           // for (Resignation resignation : l) {
                JSONObject jo = new JSONObject();

                jo.put("nic", resignation.getStaff().getNic());
